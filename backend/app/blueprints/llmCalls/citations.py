...
class Citations(LlmRequests):
    ...
    def handleRequest(self):
        ...
        template = f"""
        Your job is take three sections - claims, abstract - and a single metric (or function) and find quotes from within those sections that relate to the metric.
        ...
        You should use this format for a metric, outputting 2-3 before, highlight and after sections per section (abstract, claims). It is incredibly important that Claims, Abstract and Description have at least 1 highlighted section each.

        Now that you understand the flow. I will give you 1 metric and each of the three sections - abstract, claims. You should find 2-3 clusters in each section for the metric provided. If a sections is missing, you should ignore it and output that field as an empty list.
