...
class BamlAsyncClient:
    ...
    async def ExtractPatentMetricsFromQuery(
        self,
        patent_text: str,
...
class BamlStreamClient:
    ...
    def ExtractPatentMetricsFromQuery(
        ...
        patent_text: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[partial_types.Metrics, types.Metrics]:
      __tb__ = baml_options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb
      else:
    ...
    def WordDocSummaries(
        ...
        patent_text: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[partial_types.Summaries, types.Summaries]:
      __tb__ = baml_options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb
      else:
      ...
      return baml_py.BamlStream[partial_types.Summaries, types.Summaries](
        raw,
        lambda x: coerce(partial_mdl, x),
        lambda x: coerce(mdl, x),
        self.__ctx_manager.get(),
