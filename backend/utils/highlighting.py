    ...
    {{
        "Dispenses coffee and beans." : {{
            "claims" : [
                ...
                {{
                    "paragraph": "The coffee dispenser system of claim 6, wherein the dispenser system further comprises a sensor system for measuring a level of coffee in the container. The coffee dispenser system of claim 6, wherein the sensor system connects to a control system that drives the coffee brewer unit so as to maintain the level of coffee in the container between a predefined minimum and maximum level.",
            ...
            "description" : [
                {{
                    "paragraph": "The present invention relates to the field of beverage preparation appliances, specifically to an automated coffee machine designed to brew high-quality coffee beverages with enhanced user convenience and customization. Traditional coffee machines often require multiple steps and separate appliances for grinding beans, brewing coffee, and frothing milk, which can be time-consuming and cumbersome.",
        ...
        "Dispenses milk." : {{
            ...
            "description" : [
                {{
                    "paragraph": "Positioned below the grinder, the brewing chamber receives ground coffee and hot water for the brewing process. It includes a removable filter basket for easy cleaning and maintenance. A built-in milk frother adjacent to the brewing chamber, capable of frothing milk to the desired consistency. The frother includes a steam wand and a dedicated milk container. Located on the front panel of the machine, the touch screen interface allows users to select beverage types, customize brew strength and volume, and initiate the self-cleaning process.",
