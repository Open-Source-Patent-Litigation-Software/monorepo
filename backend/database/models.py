...
class OrganizationUser(Base):
    ...
    organization_id = Column(
        Integer, ForeignKey("public.organization.id", ondelete="CASCADE"), primary_key=True
    )
    user_id = Column(
...
class Folder(Base):
    ...
    organization_id = Column(
        Integer, ForeignKey("public.organization.id", ondelete="CASCADE"), nullable=False
    )
    user_id = Column(
        Integer, ForeignKey("public.reg_user.id", ondelete="CASCADE"), nullable=False
    )
    parent_folder_id = Column(Integer, ForeignKey("public.folder.id", ondelete="CASCADE"))
